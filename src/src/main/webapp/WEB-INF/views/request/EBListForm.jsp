...
<body>
	 <form id="joinForm">
      <div id="joinHeader"> <span id="h1">업체추천신청서관리</span></div>
      <table>
          ...
          <c:forEach items="${requestDTO}" var="requestDTO">
						<a class="text-secondary" href="${pageContext.request.contextPath }/request/read/${requestDTO.formnum}"></a>
						<tr>					
            <td style="text-align: center;">${requestDTO.formnum }</td>
            <td><a class="requestTitle" href="${pageContext.request.contextPath }/request/read/${requestDTO.formnum}">[${requestDTO.custname }]님의 신청서</a></td>
