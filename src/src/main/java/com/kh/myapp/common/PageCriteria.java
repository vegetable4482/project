...
//검색어타입 읽어오기
	public String getSearchType2() {
		...
		if(rc instanceof FindCriteria) {
			searchType2 = ((FindCriteria)rc).getSearchType();
		}			
		return searchType2;
	}
	...
	public String getSearchType3() {
		String searchType3 = null;
		if(rc instanceof FindCriteria) {
			searchType3 = ((FindCriteria)rc).getSearchType();
		}			
		return searchType3;
	}
	...
	public String getSearchType4() {
		String searchType4 = null;
		if(rc instanceof FindCriteria) {
			searchType4 = ((FindCriteria)rc).getSearchType();
		}			
		return searchType4;
	}
